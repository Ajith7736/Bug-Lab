...
function page() {
  ...
  return (
    <>
      ...
      <div className='bg-white z-10 text-black font-semibold h-auto p-5 text-xl'>This web page contains a <span className='text-red-500'>xss</span> vulnarability in the input field.So exploit this vulnerability to show an <span className='text-red-500'>alert box</span> in the page.
