    ...
    <>
      ...
      <div className="w-full h-auto pt-5 lg:pt-15">
        ...
        <div className="flex mt-10 flex-col gap-10 items-center lg:flex-row lg:flex-wrap lg:justify-center">
          <div data-aos="fade-up" className="flex flex-col w-[70vw] max-[450px]:h-[28vh] max-[380px]:h-[35vh] h-[40vh] justify-between lg:w-[20vw] bg-white/5 border border-gray-800 p-5 gap-5 max-[450px]:gap-7 max-[450px]:justify-normal items-center text-center rounded-2xl">
          ...
          <div data-aos="fade-up" className="flex flex-col w-[70vw] max-[450px]:h-[28vh] max-[380px]:h-[35vh] h-[40vh] justify-between border-animate-pulse lg:w-[20vw] bg-white/5 border border-gray-800 p-5 gap-5 max-[450px]:gap-7 max-[450px]:justify-normal items-center text-center rounded-2xl">
