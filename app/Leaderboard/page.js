        ...
        <div className='flex flex-col lg:items-center mb-10'>
          {
            userdata?.map((item, index) => {
              return <div key={index} className='bg-white/5 mt-10 h-[8vh] md:h-[6vh] xl:landscape:h-[10vh] landscape:h-[15vh] lg:h-[5vh] xl:h-[8vh] lg:w-[60vw] rounded-full p-5 flex items-center border border-gray-800 justify-between'>
