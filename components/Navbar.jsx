...
function Navbar() {
    ...
    return (
        <>
            <div className='hidden md:flex justify-between bg-white/5 backdrop-blur-sm rounded-full py-5 px-10 items-center h-[10vh] md:h-[6vh] xl:landscape:h-[10vh] landscape:h-[18vh] xl:h-[10vh] m-5'>
