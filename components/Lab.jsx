...
function Lab(params) {
    ...
    return (
        <div className=' h-[10vh] md:h-[9vh] mt-8 w-[90vw] xl:w-[40vw] border border-gray-800 rounded-full flex items-center justify-evenly'>
            ...
            <Link href={params.href !== '/Login' ? `/Labs/${params.href}` : '/Login'} className='bg-white h-[10vh] md:h-[9vh] w-[80%] rounded-r-full text-black flex items-center p-2 font-bold cursor-pointer' >
